<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\wamp64\www\web\Edu\public/../application/admin\view\notice\index.html";i:1478092225;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<body>
  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      ...
      <tr>
        <td colspan="8"><div class="pagelist"> <?php echo $result->render();; ?> </div></td>
      </tr>
    </table>
  </div>
</form>
