<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\wamp64\www\web\Edu\public/../application/index\view\index\index.html";i:1478482414;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="width_1200 margin_auto">
        <div class="width100 float_l height460 posi_relative">
            <div class="width100 float_l">
                <div class="focusBox">
                    <ul class="pic">
                        <li><a href="<?php echo url('Video/index'); ?>" ><img src="__PUBLIC__/img/uiz21.jpg" /></a></li>
                        <li><a href="<?php echo url('Video/index'); ?>" ><img src="__PUBLIC__/img/uiz20.jpg" /></a></li>
                    </ul>
                ...
                <div class="width100 float_l tab_qiehuan ">
                    <div class="width100 float_l text_c height64 line_hei64 color_white bianhuabeijing backg_jqian padding_lr20">
                        <div class="width100 float_l text_l height64 line_hei64 color_white border_b_baise fon_siz16">
                            <span><a href="<?php echo url('Video/index',['id' => $vo['id']]); ?>"><?php echo $vo['name']; ?></a></span>
                        ...
                        <div class="width100 float_l padding40">
                            <div class="width100 float_l margin_b40">
                                ...
                                <ul class="width100 ul_lis float_l">
                                 ...
                                 <li><a href="<?php echo url('Video/index',['id' => $list['id']]); ?>"><?php echo $list['name']; ?></a></li>
                                  <li>/</li>
                            ...
                            <div class="width100 float_l margin_b40">
                                ...
                                <ul class="width100 ul_lis float_l">
                                <?php if(is_array($list['vi']) || $list['vi'] instanceof \think\Collection): $i = 0; $__LIST__ = $list['vi'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$video): $mod = ($i % 2 );++$i;?>
                                    <li class="width100 float_l margin_b15"><a  href="<?php echo url('Details/index',['id' => $list['id']]); ?>">课程 | <?php echo $video['videoname']; ?></a>
                                    </li>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                </ul>
                            </div>
    ...
    <div class="width_1200 margin_auto">
        ...
        <div class="width100 float_l margin_b20">
            ...
            <div class="float_r bianshou">
                <span><a href="<?php echo url('Video/index'); ?>">更多</a></span>
            </div>
        </div>
...
<?php if(is_array($good) || $good instanceof \think\Collection): $i = 0; $__LIST__ = $good;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <a href="<?php echo url('Details/index',['id' => $vo['id']]); ?>">
            <div class="width_224 height172 float_l margin_r20 border_shadow jingguoxianshi over_pos bianshou">
               ...
               <a href="<?php echo url('Details/zan',['id' => $vo['id']]); ?>"> <span class="glyphicon glyphicon-thumbs-up"></span></a>
            ...
            <div class="width100 float_l padding_lr20 dadiv">
                <div class="width100 float_l border_t padding_t10">
                    <ul class="tongli_ys chaochuyincang">
                        ...
                        <li><a href="<?php echo url('Details/index',['id' => $sdata[10]['id']]); ?>"><span class="diandian">.</span><?php echo $sdata[11]['videoname']; ?></a></li>
