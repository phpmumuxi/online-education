<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\wamp64\www\edu\public/../application/index\view\details\index.html";i:1478852540;s:60:"D:\wamp64\www\edu\public/../application/index\view\base.html";i:1478760512;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<script type="text/javascript" src="http://www.lanxiang.com/static/index/ckplayer/js/offlights.js"></script>
</head>
...
-->
<div align="center">
<script type="text/javascript" src="http://www.lanxiang.com/static/index/ckplayer/ckplayer/ckplayer.js" charset="utf-8"></script>
<script type="text/javascript">
	//如果你不需要某项设置，可以直接删除，注意var flashvars的最后一个值后面不能有逗号	function loadedHandler(){
	...
	var flashvars={
		f:'http://www.lanxiang.com/static/uploads/video/<?php echo $name; ?>',//视频地址
		a:'',//调用时的参数，只有当s>0的时候有效
		s:'0',//调用方式，0=普通方法（f=视频地址），1=网址形式,2=xml形式，3=swf形式(s>0时f=网址，配合a来完成对地址的组装)
		c:'0',//是否读取文本配置,0不是，1是
		x:'',//调用配置文件路径，只有在c=1时使用。默认为空调用的是ckplayer.xml
		i:'http://www.lanxiang.com/static/uploads/img/<?php echo $picname; ?>',//初始图片地址
		d:'http://www.lanxiang.com/static/uploads/img/<?php echo $picname; ?>',//暂停时播放的广告，swf/图片,多个用竖线隔开，图片要加链接地址，没有的时候留空就行
		u:'',//暂停时如果是图片的话，加个链接地址
		...
		z:'http://www.lanxiang.com/static/uploads/img/<?php echo $picname; ?>',//缓冲广告，只能放一个，swf格式
	...
	var video=['http://www.lanxiang.com/static/uploads/video/<?php echo $name; ?>->video/mp4'];
	CKobject.embed('http://www.lanxiang.com/static/index/ckplayer/ckplayer/ckplayer.swf','a1','ckplayer_a1','100%','100%',false,flashvars,video,params);
	/*
