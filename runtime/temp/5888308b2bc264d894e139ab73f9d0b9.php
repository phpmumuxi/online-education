<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\wamp64\www\edu\public/../application/admin\view\user\edit.html";i:1478616034;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
  ...
  <div class="body-content">
    ...
    <form method="post" class="form-x" action="<?php echo url('update'); ?>" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="file" id="url1" name="picture" class="input tips" style="width:25%; float:left;"  value=""  data-toggle="hover" data-place="right" data-image="<?php if($list['picture']=='1.jpg'): ?>__PUBLIC__/images/1.jpg<?php else: ?>__IMGL__/<?php echo $list['picture']; endif; ?>" />
