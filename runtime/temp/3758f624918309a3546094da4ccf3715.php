<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\wamp64\www\web\edu\public/../application/admin\view\cat\index.html";i:1478616036;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
       ...
       <tr>
        ...
        <tr>
          <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="<?php echo $data['id']; ?>" />
           <?php echo $data['id']; ?></td>
          <td><a href="<?php echo url('children',['id'=> $data['id']]); ?>"><?php echo $data['name']; ?></a></td>
          ...
          <td><a href="<?php echo url('add',['id'=> $data['id']]); ?>">添加子版块</a></td>
