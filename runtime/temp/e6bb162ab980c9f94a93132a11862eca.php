<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wamp64\www\edu\public/../application/index\view\ask\alluser.html";i:1478696404;s:60:"D:\wamp64\www\edu\public/../application/index\view\base.html";i:1478760512;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
	        ...
	        <div id="qaLoadListData">
	          <div class="sortlist">
	        	...
	        	<div class="comp-filter-bar">
				    <a href="<?php echo url('Ask/alluser',['id' => $result[0]['id']]); ?>" class="bar-item active">全部</a>
				    <a href="<?php echo url('Ask/jinghua',['id' => $result[0]['id']]); ?>" class="bar-item ">精华</a>
				    <div class="tiwen">
						<a href="<?php echo url('Ask/add',['id' => $result[0]['id']]); ?>" class="btn btn-primary btn-lg" >我要提问</a>
					</div>
				</div>
				...
				<div class="answertabcon">
				        ...
				        <?php if(is_array($ask) || $ask instanceof \think\Collection): $i = 0; $__LIST__ = $ask;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				            ...
				            <div class="headslider qa-medias l">
				                ...
				                <img src="__IMG__/<?php echo $vo['user']['picture']; ?>" width="40" height="40">
				                </a>
				            </div>
				            ...
				            <div class="wendaslider qa-content">
				                <h2 class="wendaquetitle qa-header">
				                    ...
				                    <div >
				                        <a href="<?php echo url('Ask/detail',['id'=> $vo['id']]); ?>" target="_blank" >
				                ...
				                <div class="replycont qa-body clearfix">
				                    ...
				                    <span class="replysign praise">
				                   		 [最新 <a href="" target="_blank" title="叫我煤老板" class="nickname"><?php echo $vo['reply']['user']['username']; ?></a>的回答]
				                    </span>
				                    <span class="replydet"><?php echo $vo['reply']['content']; ?></span>
				                ...
				                <div class="replymegfooter qa-footer clearfix">
				                    <div class="wenda-time">
				                        <div class="l-box l">
				                            <em>时间：<?php echo date( 'Y-m-d H:i:s',$vo['create_time']); ?></em>
				                                                        <a href="http://www.imooc.com/video/12599" target="_blank">源自：<?php echo $result[0]['videoname']; ?></a>
				                        </div>

				                        <a href="<?php echo url('Ask/detail',['id'=> $vo['id']]); ?>" target="_blank" class="replynumber static-count r">
				                            <span class="static-item answer">
				                                <b class="val"></b>
				                                <span class="key"><?php echo $vo['count']; ?>回答</span>
				                            </span>
				                            <span class="static-item">
				                                <b class="val"><?php echo $vo['clicknum']; ?></b>
