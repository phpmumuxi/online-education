<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\wamp64\www\web\edu\public/../application/admin\view\vcomment\index.html";i:1478755230;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<form method="post" action="<?php echo url('delete'); ?>" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 视频评论列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    ...
    <table class="table table-hover text-center">
       <tr>
	        ...
	        <th width="10%">评论的用户</th>
	        <th width="20%">评论的视频</th>
	        <th >评论内容</th>
	        <th>评论时间</th>
	        <th width="310">操作</th>
	   </tr>
        ...
        <tr>
          ...
          <td><a href="<?php echo url('Index/Details/index',['id' => $data['video']['id'] ]); ?>" target="_blank"><?php echo $data['content']; ?></a></td>
