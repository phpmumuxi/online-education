<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\wamp64\www\edu\public/../application/index\view\reply\user.html";i:1478699042;s:59:"D:\wamp64\www\edu\public/../application/index\view\nav.html";i:1478760534;}*/ ?>
<!DOCTYPE html>
...
<body>
  ...
  <div class="u-container">
    <!--用户空间提问，回答，关注通用导航-->
    <div class="nav">
        <a href="<?php echo url('Ask/user'); ?>" >我的提问</a>
        <a href="<?php echo url('Reply/user'); ?>" class="active">我的回答</a>
    </div>
    <!-- .nav end-->
    <?php if($result): if(is_array($result) || $result instanceof \think\Collection): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
        <div class="ques-list">
            <div class="ques-answer">
                ...
                <div class="from-tag">
                    来自<a href="<?php echo url('Ask/detail',['id'=>$data['qid']]); ?>" target="_blank"><?php echo $data['ask']['title']; ?></a>
                </div><!--.from-tag end-->
                <div class="ques-con">
                    <a href="<?php echo url('Ask/detail',['id'=>$data['qid']]); ?>" class="ques-con-content" target="_blank"><?php echo $data['content']; ?></a>
                </div><!-- .ques-con end-->
                <div class="about-info">
                    <span class="time"><?php echo date("Y-m-d H:i:s",$data['create_time']); ?></span>
                    <a href="<?php echo url('Ask/detail',['id'=>$data['id']]); ?>" target="_blank" class="reply-num">共<?php echo $data['count']; ?>个回答</a>
                </div><!-- .about-info end -->
            </div><!-- .ques-answer end -->
        ...
        <div class="nodata">
            你还没有回答过问题，可以先 <a href="<?php echo url('Ask/index'); ?>">去看看学习中遇到的问题</a>
        </div>
