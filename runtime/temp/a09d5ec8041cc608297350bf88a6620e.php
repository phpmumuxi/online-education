<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\wamp64\www\web\Edu\public/../application/admin\view\cat\index.html";i:1478502587;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
        ...
        <tr>
          ...
          <td>
          	<?php if($data['status'] == 2): ?>
          		<a href="<?php echo url('delete',['id'=>$data['id']]); ?>">在用</a>
			<?php else: ?>
			 	<a href="<?php echo url('delete',['id'=>$data['id']]); ?>">隐藏</a>
			 <?php endif; ?>
          </td>
