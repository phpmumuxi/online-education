<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\wamp64\www\web\Edu\public/../application/admin\view\note\index.html";i:1478502256;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <table class="table table-hover text-center">
       <tr>
        ...
        <tr>
          ...
          <td><?php echo $data['video']['videoname']; ?></td>
          <td><?php echo $data['title']; ?></td>
          <td><?php echo $data['content']; ?></td>
          <td><?php echo date( 'Y-m-d H:i:s',$data['create_time']); ?></td>
          <td>
          	<?php if($data['good'] == 0): ?><a href="<?php echo url('good',['id'=>$data['id']]); ?>">不推荐</a>
			<?php else: ?><a href="<?php echo url('good',['id'=>$data['id']]); ?>">推荐</a>
			<?php endif; ?>
          </td>
