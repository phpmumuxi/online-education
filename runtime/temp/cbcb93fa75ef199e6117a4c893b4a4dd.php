<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\wamp64\www\web\Edu\public/../application/index\view\note\user.html";i:1478516673;s:63:"D:\wamp64\www\web\Edu\public/../application/index\view\nav.html";i:1478504413;}*/ ?>
<!DOCTYPE html>
			...
			<div class="u-container">
				...
				<div id="articleMain" class="article-main">
					...
					<ul class="clearfix toptab">
						<li class="tabactive">
							<a href="http://www.imooc.com/u/2125817/articles">我的手记</a>
						</li>
						<div class="left_warp">
					...
					<?php if($result): if(is_array($result) || $result instanceof \think\Collection): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
						...
						<h3 class="item-title">
               			 	<a target="_blank" href="http://www.imooc.com/article/13644" class="title-detail"><?php echo $data['title']; ?></a>
               			 </h3>
							<!-- text -->
							<div class="">
						...
						<?php endforeach; endif; else: echo "" ;endif; else: ?>
							<div class="nodata">
					            你还没有任何手记，快去 <a href="http://coding.imooc.com/">发表手记</a> 吧。
					        </div>
						<?php endif; ?>
						<!-- 分页 -->
					</div>
