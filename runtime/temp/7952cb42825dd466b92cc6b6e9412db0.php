<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wamp64\www\edu\public/../application/admin\view\cat\children.html";i:1478761260;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<form method="post" action="<?php echo url('delete'); ?>" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 子版块视频列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<?php echo url('add'); ?>"> 添加板块</a> </li>
    ...
    <table class="table table-hover text-center">
       <tr>
        ...
        <tr>
          ...
          <a href="<?php echo url('delete',['id'=>$data['id']]); ?>">
          在用</a>
			  <?php else: ?>
			 <a href="<?php echo url('delete',['id'=>$data['id']]); ?>">
          隐藏</a>
          ...
          <td><a href="<?php echo url('add'); ?>">添加版块</a></td>
