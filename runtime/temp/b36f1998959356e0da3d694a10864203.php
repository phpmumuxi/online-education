<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wamp64\www\web\Edu\public/../application/index\view\ask\add.html";i:1478523544;s:64:"D:\wamp64\www\web\Edu\public/../application/index\view\base.html";i:1478482414;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<html lang="zh">
    ...
    <body>
    <form action="<?php echo url('Note/check'); ?>" method="post">
        <div id="layout">
    ...
    <div class="col-md-7 col-md-offset-1"  >
      <input type="text" class="form-control" name="title" placeholder="手记标题">
    </div>
  </div>
<header>
                <h3>内容</h3>
