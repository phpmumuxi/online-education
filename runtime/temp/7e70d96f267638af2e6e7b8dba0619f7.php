<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\wamp64\www\web\Edu\public/../application/index\view\details\index.html";i:1478482414;s:64:"D:\wamp64\www\web\Edu\public/../application/index\view\base.html";i:1478482414;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<script type="text/javascript" src="http://localhost/edu/public/static/index/ckplayer/js/offlights.js"></script>
</head>
...
-->
<div align="center">
<script type="text/javascript" src="http://localhost/edu/public/static/index/ckplayer/ckplayer/ckplayer.js" charset="utf-8"></script>
...
<div class="course-subcontainer clearfix">
  <div class="course-left">
    ...
    <li class="course-menu-item" >
    	<a id = "zan" href="<?php echo url('Details/zan',['id' => $result[0]['id']]); ?>" rel="<?php echo $result[0]['id']; ?>">
    	<span class="glyphicon glyphicon-thumbs-up"></span>
    	</a>
    </li>
    <li class="course-menu-item"><a href="" id="plMenu">评论</a></li>
...
<div id="disArea" class="lists-container list-wrap">
    <div id="pl-content" class="list-tab-con">
        <div class="publish clearfix" id="discus-publish">
            <div class="publish-wrap publish-wrap-pl">
                <div class="pl-input-wrap clearfix">
                    <a href="http://www.imooc.com/u/4074002" class="user-head l">
                        <img src="images/57ea04030001fa0201000100-100-100.jpg" alt=" ">
                    </a>
        ...
        <div id="plLoadListData"><div class="pl-container"> <ul>   <li class="pl-list clearfix"> <div class="pl-list-avator"> <a href="http://www.imooc.com/u/1937878/courses" target="_blank"><img width="40" height="40" src="images/55600f9e0001bef602540299-40-40.jpg" title="心的幻想"></a> </div> <div class="pl-list-main"> <div class="pl-list-nick"> <a href="http://www.imooc.com/u/1937878/courses" target="_blank">心的幻想</a> </div> <div class="pl-list-content">声音好听，我听弯了</div>  <div class="pl-list-btm clearfix"> <span class="pl-list-time l">时间: 2015-11-04</span>  <a title="赞" href="javascript:;" class="js-pl-praise list-praise r" data-id="129462"><i class="icon-thumb-revert"></i>  <span>19</span></a> </div> </div> </li>  </ul></div><div class="page pl-list-page"></div></div>
    </div>
  ...
  <div class="wendalist js-right-wenda" style="display: block;">
    <div class="course-right-title">
      ...
      <ul><li><a href="#" target="_blank">php的搜索功能</a><i>2 回答</i></li></ul>
  </div>
  <div class="articlelist js-right-article" style="display: block;">
    ...
    <ul><li><a href="#" target="_blank">git参考手册--文字说明+git速查命令表(图片)</a></li></ul>
  </div>  </div>
</div>
