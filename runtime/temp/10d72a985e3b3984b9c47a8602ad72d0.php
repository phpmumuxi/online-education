<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\wamp64\www\web\edu\public/../application/admin\view\reply\index.html";i:1478755616;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<form method="post" action="<?php echo url('delete'); ?>" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 视频回复列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    ...
    <table class="table table-hover text-center">
       <tr>
	        ...
	        <th width="10%">回复的用户</th>
	        <th width="10%">回复的视频</th>
	        <th width="15%">回复的问题</th>
	        <th >回复的内容</th>
	        <th width="15%">回复时间</th>
	        <th width="310">操作</th>
	   </tr>
        ...
        <tr>
          ...
          <td><a href="<?php echo url('Index/Ask/detail',['id' => $data['id'] ]); ?>" target="_blank"><?php echo $data['ask']['title']; ?></a></td>
